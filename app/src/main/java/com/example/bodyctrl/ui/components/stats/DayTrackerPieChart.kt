package com.example.bodyctrl.ui.components.stats
...
fun DayTrackerPieChart(
    ...
    val progressColor: Color = MaterialTheme.colorScheme.primaryContainer
    val backgroundColor: Color = MaterialTheme.colorScheme.primary
    val pieTextColor: Color = MaterialTheme.colorScheme.tertiary
    val pieValueColor: Color = MaterialTheme.colorScheme.primary
    ...
    val pieTextMeasurer = rememberTextMeasurer()
    val pieTextLayoutResult = pieTextMeasurer.measure(text = AnnotatedString(pieText))
    val pieTextSize = pieTextLayoutResult.size
    ...
    Canvas(
        ...
        drawText(
            ...
            pieText,
            topLeft = Offset(
                (this.size.width - pieTextSize.width) / 2f,
                (this.size.height - pieTextSize.height - pieValueSize.height) / 2f
            ),
            maxLines = 1,
            style = TextStyle(color = pieTextColor)
        )
        drawText(
            pieValueMeasurer,
            pieValue,
            topLeft = Offset(
                ...
                (this.size.height - pieValueSize.height + pieTextSize.height) / 2f
            ),
            maxLines = 1,
